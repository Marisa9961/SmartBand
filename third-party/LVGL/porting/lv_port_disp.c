...
void lv_port_disp_init(void) {
   ...
   * In flush_cb DMA or similar hardware should be used to update the display
   * in the background.*/
  LV_ATTRIBUTE_MEM_ALIGN
   ...
   * see their comments*/
  // LV_ATTRIBUTE_MEM_ALIGN
  // static uint8_t buf_3_1[MY_DISP_HOR_RES * MY_DISP_VER_RES *
  // BYTE_PER_PIXEL];

  // LV_ATTRIBUTE_MEM_ALIGN
  // static uint8_t buf_3_2[MY_DISP_HOR_RES * MY_DISP_VER_RES *
  // BYTE_PER_PIXEL]; lv_display_set_buffers(disp, buf_3_1, buf_3_2,
  // sizeof(buf_3_1),
